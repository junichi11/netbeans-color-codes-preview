...
@OptionsPanelController.SubRegistration(
        location = "Advanced",
        displayName = "#AdvancedOption_DisplayName_ColorCodesPreview",
        keywords = "#AdvancedOption_Keywords_ColorCodesPreview",
        keywordsCategory = "Advanced/ColorCodesPreview"
)
...
public final class ColorCodesPreviewOptionsPanelController extends OptionsPanelController {
    ...
    private ColorCodesPreviewPanel getPanel() {
        if (panel == null) {
            panel = new ColorCodesPreviewPanel(this);
        }
        return panel;
    }
