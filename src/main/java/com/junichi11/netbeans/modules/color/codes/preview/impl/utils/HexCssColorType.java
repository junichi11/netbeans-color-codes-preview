...
public enum HexCssColorType implements ColorType {
    ...
    CSS_INT_RGB(String.format(HexCssColorType.CSS_RGB_FORMAT, ColorType.DECIMAL_INT_R_G_B_VALUE_REGEX, ColorType.DECIMAL_INT_R_G_B_VALUE_REGEX, ColorType.DECIMAL_INT_R_G_B_VALUE_REGEX)),
    ...
    CSS_INT_RGBA(String.format(HexCssColorType.CSS_RGBA_FORMAT, ColorType.DECIMAL_INT_R_G_B_VALUE_REGEX, ColorType.DECIMAL_INT_R_G_B_VALUE_REGEX, ColorType.DECIMAL_INT_R_G_B_VALUE_REGEX, HexCssColorType.ALPHA_VALUE_FORMAT)),
